...
/**
 * An importer interface for importing / converting non-graphedit projects to
 * graphedit format.
 *
...
public interface IImporter {
	 ...
	 * 
	 * @return A filetypes filter object with a description and at least one
	 *         extension
	 */
	...
	/**
	 * Converts a series of model files to graphedit format and imports them into
