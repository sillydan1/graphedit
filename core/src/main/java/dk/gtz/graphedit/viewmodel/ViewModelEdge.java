 ...
 */
public class ViewModelEdge extends AutoProperty<ViewModelEdge>
	...
	/**
	 * Check if the proposed target vertex is a valid target. Use this in your
	 * syntax plugins to limit which vertices can be targeted by edges
	 * 
	 * @param target The proposed vertex id to target
	 * @param graph  The graph containing this edge and the proposed target vertex
	 * @return true if the target is a valid target vertex for this edge, false
	 *         otherwise
	 */
	...
	/**
	 * Check if the proposed source vertex is a valid source. Use this in your
	 * syntax plugins to limit which vertices can have edges
	 * 
	 * @param source The proposed vertex id to source
	 * @param graph  The graph containing this edge and the proposed source vertex
	 * @return true if the source is a valid source vertex for this edge, false
	 *         otherwise
	 */
