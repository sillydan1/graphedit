...
public interface IBufferContainer {
	 ...
	 * @throws RuntimeException ultimately up to the implementation, but this could
	 *                          be that there is no instance associated with the
	 *                          provided key
	 */
	 ...
	 * @throws Exception ultimately up to the implementation, but this could be that
	 *                   the key already exists or that the resource could not be
	 *                   inferred
	 */
	 ...
	 * @throws RuntimeException ultimately up to the implementation, but this could
	 *                          be that the key already exists
	 */
	void open(String key, ViewModelProjectResource model) throws RuntimeException;

	/**
	 * Check if the collection contains a project resource instance with the
	 * provided key
	 * 
	 * @param key the key to lookup
	 * @return {@code true} if the collection contains a project resource instance
	 *         with the associated key, otherwise {@code false}
	 */
