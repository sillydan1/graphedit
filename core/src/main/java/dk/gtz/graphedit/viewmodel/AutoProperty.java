...
/**
 * This class is a base class that automatically listen and fire events to
 * changes in their fields marked with {@link Autolisten}.
 * <br/>
 * <br/>
 * Usage Example:
 * 
	...
	public void addListener(InvalidationListener listener) {
		for (var field : fields) {
			...
			try {
				...
				logger.error("error adding invalidation listener '{}': {}", field.getName(),
						e.getMessage(), e);
			}
		}
	}
	...
	public void removeListener(InvalidationListener listener) {
		for (var field : fields) {
			...
			try {
				...
				logger.error("error removing invalidation listener '{}': {}", field.getName(),
						e.getMessage(), e);
			}
		}
	}
	...
	public void bindBidirectional(Property<T> other) {
		for (var field : fields) {
			...
			try {
				...
				logger.error("error binding bidirectionally '{}': {}", field.getName(), e.getMessage(),
						e);
			}
		}
	}
	...
	public void unbindBidirectional(Property<T> other) {
		for (var field : fields) {
			...
			try {
				...
				logger.error("error unbinding bidirectionally '{}': {}", field.getName(),
						e.getMessage(), e);
			}
		}
	}
