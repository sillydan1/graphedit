...
public class ViewModelPoint implements Property<ViewModelPoint> {
	...
	/**
	 * Constructs a new view model point with the provided x and y coordinate
	 * properties
	 * 
	...
	public ViewModelPoint(DoubleProperty x, DoubleProperty y) {
		...
		this.x.addListener(
				(e, o, n) -> this.changeListeners.stream().forEach(l -> l.changed(this, this, this)));
		this.y.addListener(
				(e, o, n) -> this.changeListeners.stream().forEach(l -> l.changed(this, this, this)));
	}
	...
	/**
	 * Calculate the dot product between this and another point (as if they are
	 * vectors).
	 * 
