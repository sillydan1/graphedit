 ...
 * Note, not to be confused with a {@link Tooltip}, this represents a tip object for the {@link TipOfTheDayController} view.
 * @param category The category of the tip
 * @param description The description / message of the tip
 * @param imageWidth The width of the image to be shown with the tip, ignored if no image is provided.
