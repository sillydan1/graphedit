...
public interface ISelectable {
     ...
     * This is useful if you want to add event listeners to handle when the property changes.
     * @return {@code true} if the object is currently selected, otherwise {@code false}
     */
