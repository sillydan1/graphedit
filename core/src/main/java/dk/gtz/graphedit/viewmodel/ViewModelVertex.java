 ...
 * A vertex is the most basic part of a graph. It can be connected with other
 * vertices via {@link ModelEdge}s.
 */
public class ViewModelVertex extends AutoProperty<ViewModelVertex>
