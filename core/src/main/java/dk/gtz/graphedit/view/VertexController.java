...
public class VertexController extends StackPane {
	...
	/**
	 * Reference to the transform, scale and rotation matrix of the containing
	 * viewport
	 */
	 ...
	 * @param viewportAffine The transform, scale and rotation matrix of the
	 *                       containing viewport
	 * @param graph          The parent graph containing the represented viewmodel
	 *                       vertex
	 ...
	 */
	public VertexController(UUID vertexKey, ViewModelVertex vertex, Affine viewportAffine, ViewModelGraph graph,
	...
	/**
	 * Initializer function that adds the graphic to the display stack. Called
	...
	/**
	 * Initializer function that adds a label to the display stack. Called during
	 * {@link #initialize}
	 */
	...
	/**
	 * Initializer function that adds a pulse animation to the focus event. Called
	 * during {@link #initialize}
	 */
	...
	/**
	 * Initializer function that adds a scale animation and a stroke indication on
	 * mouse hover. Called during {@link #initialize}
	 */
	...
	/**
	 * Binds this' translate x and y properties to the associated vertex viewmodel
	 * position point.
	 */
	...
	/**
	 * Binds this' scale x and y properties to the associated vertex viewmodel
	 * shape's scale.
	 */
	 ...
	 */
	protected void initializeEventHandlers(ObjectProperty<ITool> selectedTool, ViewModelGraph graph,
			ViewModelEditorSettings editorSettings, String bufferKey) {
		addEventHandler(MouseEvent.ANY, e -> {
			var event = new VertexMouseEvent(e, vertexKey, vertexValue, viewportAffine, syntaxFactory,
					graph, bufferKey,
					editorSettings);
