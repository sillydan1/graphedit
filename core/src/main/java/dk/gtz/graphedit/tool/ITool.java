 ...
 * Tools are automatically instantiated and can be selected in the model editor
 * toolbar
 */
public interface ITool {
	...
	/**
	 * Event handler for the case where the model editor viewport has been
	 * interacted with with the mouse
	 * 
	...
	/**
	 * Event handler for the case where the model editor viewport has been
	 * interacted with with the keyboard
	 * 
	 * @param e The event that happened
	 */
	...
	/**
	 * Event handler for the case where a vertex has been interacted with with the
	 * mouse
	 * 
	 * @param e The event that happened
	 */
	...
	/**
	 * Event handler for the case where an edge has been interacted with with the
	 * mouse
	 * 
	 * @param e The event that happened
	 */
