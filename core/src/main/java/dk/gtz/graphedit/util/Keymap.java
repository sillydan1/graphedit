...
public class Keymap {
     ...
     * @param category The category of the keybinding. Will not create a menubar item if empty.
     * @param action The action to run when the keybinding is pressed.
     * @param description A short description of the keybinding. Will be used for menu item text in the menubar
     */
    ...
    /**
     * Set a keybinding with a category. The category can be used to group keybindings and will be displayed in the top menubar.
