...
public class ShapeUtil {
	...
	/**
	 * Will calculate the intersection point on a reactangle shape given a ray
	 * (dx,dy)
	 * 
	 * @see <a href=
	 *      "https://math.stackexchange.com/questions/2738250/intersection-of-ray-starting-inside-square-with-that-square/2738727#2738727">inspired
	 ...
	 * @return The intersection point on the rectangle. Note: (0,0) if the both dx
	 *         and dy are zero
	 */
