...
public class MapGroup<K> {
    ...
    /**
     * Returns the value associated with the key, or {@code null} if it doesn't exist
     * @param key The key to lookup
     * @return The value to which the key is mapped, or {@code null} if it doesn't exist
     */
     ...
     * @return {@code true} if the map contains the provided key, otherwise {@code false}
     */
    ...
    /**
     * Add a new key/value entry to the map and attach the {@code Node} to the group.
    ...
    /**
     * Add a collection of key/value entries to the map and attach the {@code Node}s to the group.
