 ...
 * @param modelKey The key of the related model (see {@link IBufferContainer})
 ...
 * @param lintDescription A general description of what this kind of lint represents
 * @param affectedElements A list of which syntactic elements should be highlighted
 * @param affectedRegions A list of regions in the graph that should be highlighted
 */
