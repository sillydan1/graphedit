package dk.gtz.graphedit.plugins.syntaxes.text.view;
...
public class TextVertexController extends VertexController {
	...
	public TextVertexController(UUID vertexKey, ViewModelTextVertex vertex, Affine viewportAffine,
			ViewModelGraph graph, ViewModelEditorSettings editorSettings,
